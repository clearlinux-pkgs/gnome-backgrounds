...
Version  : 48.2.1
Release  : 32
URL      : https://download.gnome.org/sources/gnome-backgrounds/48/gnome-backgrounds-48.2.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-backgrounds/48/gnome-backgrounds-48.2.1.tar.xz
...
%prep
%setup -q -n gnome-backgrounds-48.2.1
cd %{_builddir}/gnome-backgrounds-48.2.1
pushd ..
cp -a gnome-backgrounds-48.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748363460
...
/usr/share/backgrounds/gnome/pride-d.jxl
/usr/share/backgrounds/gnome/pride-l.jxl
/usr/share/backgrounds/gnome/progress-d.jxl
/usr/share/backgrounds/gnome/progress-l.jxl
...
/usr/share/gnome-background-properties/pride.xml
/usr/share/gnome-background-properties/progress.xml
