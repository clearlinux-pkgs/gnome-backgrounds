...
Version  : 3.30.0
Release  : 10
URL      : https://github.com/GNOME/gnome-backgrounds/archive/3.30.0.tar.gz
Source0  : https://github.com/GNOME/gnome-backgrounds/archive/3.30.0.tar.gz
...
%prep
%setup -q -n gnome-backgrounds-3.30.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1545227018
