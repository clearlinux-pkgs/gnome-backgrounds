...
Version  : 48.0
Release  : 31
URL      : https://download.gnome.org/sources/gnome-backgrounds/48/gnome-backgrounds-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-backgrounds/48/gnome-backgrounds-48.0.tar.xz
...
%prep
%setup -q -n gnome-backgrounds-48.0
cd %{_builddir}/gnome-backgrounds-48.0
pushd ..
cp -a gnome-backgrounds-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742585339
