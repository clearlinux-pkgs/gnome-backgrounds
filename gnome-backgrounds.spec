...
Source0  : https://download.gnome.org/sources/gnome-backgrounds/43/gnome-backgrounds-43.1.tar.xz
...
%prep
%setup -q -n gnome-backgrounds-43.1
cd %{_builddir}/gnome-backgrounds-43.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676487917
